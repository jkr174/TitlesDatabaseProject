...
namespace TitlesDatabaseProject.SQLBooksDBDataSetTableAdapters {
    ...
    public partial class TitlesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Titles] WHERE (((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Year_Published = 1 AND [Year_Published] IS NULL) OR ([Year_Published] = @Original_Year_Published)) AND ([ISBN] = @Original_ISBN) AND ([PubID] = @Original_PubID))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Year_Published", global::System.Data.SqlDbType.SmallInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Year_Published", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Titles] SET [Title] = @Title, [Year_Published] = @Year_Published, [ISBN] = @ISBN, [PubID] = @PubID WHERE (((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Year_Published = 1 AND [Year_Published] IS NULL) OR ([Year_Published] = @Original_Year_Published)) AND ([ISBN] = @Original_ISBN) AND ([PubID] = @Original_PubID));
SELECT Title, Year_Published, ISBN, PubID FROM Titles WHERE (ISBN = @ISBN)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Year_Published", global::System.Data.SqlDbType.SmallInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Year_Published", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TitlesDatabaseProject.Properties.Settings.Default.SQLBooksDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Title, Year_Published, ISBN, PubID FROM dbo.Titles";
        ...
        public virtual int Delete(string Original_Title, global::System.Nullable<short> Original_Year_Published, string Original_ISBN, int Original_PubID) {
        ...
        public virtual int Update(string Title, global::System.Nullable<short> Year_Published, string ISBN, int PubID, string Original_Title, global::System.Nullable<short> Original_Year_Published, string Original_ISBN, int Original_PubID) {
            if ((Title == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, global::System.Nullable<short> Year_Published, int PubID, string Original_Title, global::System.Nullable<short> Original_Year_Published, string Original_ISBN, int Original_PubID) {
